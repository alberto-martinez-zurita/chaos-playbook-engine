...
- **👉 Lesson:** _Generic resilience fails. Semantic resilience wins._
...
- **The Pivot:** We adopted the **Hybrid Engine Strategy (ADR-001)**. We mandated a strict separation:
  - **The Brain (LLM):** Decides _what_ to do (Reasoning).
...
- **👉 Lesson:** _Never let the LLM touch the network directly. Always mediate through a Deterministic Proxy._
...
- **👉 Lesson:** _Observability must be streamed, not buffered. Efficiency is a prerequisite for scale._
...
- **👉 Lesson:** _If you can't reproduce the chaos, you can't validate the prompt._
...
- **The Pivot:** We translated latency and error rates into **Unit Economics**.
  - _Latency Cost:_ +180ms = $0.005 compute.
  - _Recovery Value:_ 1 Saved Order = $100 revenue.
- **The Result:** A calculated **3x ROI** that made the business case undeniable.
- **👉 Lesson:** _Don't sell reliability. Sell Revenue Protection._
