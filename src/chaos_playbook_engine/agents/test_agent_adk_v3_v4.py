...
TestAgent v3: VERSIÓN FINAL FINAL

CAMBIO CRÍTICO EN _run_single_test():
- SIEMPRE llama a _tool_decide_retry() en caso de error
- Ignora el playbook "fail" y deja que Gemini decida
- Así Gemini REALMENTE RAZONA en cada error
"""
...
class TestAgentADK:
    ...
    Clase simple que ejecuta tests con retry logic y llamadas a Gemini.
    """
    ...
    def __init__(
        ...
        # Crear modelo Gemini una sola vez
        self.gemini_model = Gemini(model_name=llm_model)
...
{{
    ...
    async def _run_single_test(
        ...
        while attempt < max_retries:
            ...
            # ✅ CAMBIO CRÍTICO: SIEMPRE llamar a Gemini, incluso si playbook dice "fail"
            # Dejar que Gemini decida si reintentar o no
